...
/**
 * TPaneAsientos nos deja elegir entre más de una ventana, en este caso, entre el primer o segundo piso del bus.
 * 
 ...
 * @param estandar nos indica si el autobús es de un sólo piso, en ese caso, sólo hay una ventana y, por lo tanto, no se puede tabular entre pisos.
 */
...
public class TPaneAsientos extends JTabbedPane {
    ...
    /**
     * El método initComponent inicializa los componentes del panel, viendo si el bus es de uno o dos pisos, para adaptarse correctamente.
     */
